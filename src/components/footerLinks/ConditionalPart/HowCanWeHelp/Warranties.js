...
export default function Warranties() {
  return (
    <section className={classes["warranties"]}>
      ...
      <p>
        Grease's warranty provides coverage for defects in manufacturing only,
        and expressly excludes coverage for excessive wear and tear and/or
        physical/accidental abuse, loss and theft.
      </p>
      <p>
        Grease Used Dept. warranty: If an item is returned within the warranty
      ...
      <p>
        The warranty is valid only at Grease Camera. Improper repair or warranty
        service performed by someone other than Grease Camera will void this
        warranty.
      </p>
      <p>
        Grease Camera disclaims any liability for consequential or incidental
        damages, for breach of written or implied warranty of an item, including
        merchantability or fitness for a particular purpose. An Grease warranty
