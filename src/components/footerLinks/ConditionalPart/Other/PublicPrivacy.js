...
import classes from "./PublicPrivacy.module.scss";
      ...
      <div className={classes["public-privacy-body"]}>
        ...
        <div>
          ...
          <p>
            ...
            utmost care and standard of security.
          </p>
        </div>
        <div>
          <p>
        ...
        <div>
          <p>
            It is important to note that this notice does not apply to any third
            parties or affiliates, or how they may use your personal data. For
            information regarding the way third parties and affiliates handle
            your data, please review the privacy policies or notices provided by
            each specific third party.
          </p>
        </div>
        <div>
          <p>
        ...
        <div>
          <ul>
            <li>Categories or specific data that is collected about you</li>
            <li>
        ...
        <div>
          <p>
            ...
            and cookie/beacon information be removed from our databases and
            systems. You will not be a subject of discriminatory treatment as a
            result of your choice to exercise your privacy rights.
          </p>
        </div>
        <div>
          <p>
        ...
        <div>
          <p>
            <span>Information we collect when applying for financing.</span>
          </p>
        </div>
        <div>
          <ul>
        ...
        <div>
          <p>
            <span>
              Information we collect from our websites, applications, or
              services.
            </span>
          </p>
        </div>
        <div>
          <ul>
            ...
            <li>Hardware or software usage</li>
            <li>Device usage</li>
            <li>Browser usage</li>
            <li>Device event data</li>
            <li>Product interaction</li>
            <li>Cookie/beacon/pixel data</li>
            <li>Location data</li>
          </ul>
        </div>
        <div>
          <p>
            <span>Information collected from third parties.</span>
          </p>
        </div>
        <div>
          <ul>
            ...
            <li>Mailing address</li>
            <li>Phone number</li>
            <li>Password (account linking)</li>
            <li>Social media accounts</li>
            <li>Demographic data</li>
            <li>Fraud detection data</li>
            <li>Credit data</li>
            <li>Activity data (interactions and preferences)</li>
          </ul>
        </div>
        <div>
          <p>
        ...
        <div>
          <ul>
            <li>
              ...
              analysis and business analytics, for audits, for customer support,
        ...
        <div>
          <p>
            ...
            . Please note that electing to opt-out from the aforementioned
            manners of advertising does not mean that you will not receive
            advertising on your browser or applications, it simply means that
            the advertising that is pushed to you may not be targeted to your
            interests or behavior. Please also be aware that deleting browser
            cookies can remove the cookie configuration you have created, and
            that you may need to complete the op-out process again in the
            future.
          </p>
        </div>
        <div>
        ...
        <div>
          <p>
            ...
            information that may be needed to fulfil your request.
          </p>
        </div>
        <div>
          <p>
        ...
        <div>
          <p>
            <span>California Consumer Privacy Act (CCPA):</span> The California
            Consumer Privacy Act is a California law charged with defining the
            extent of data protection and privacy for Californian consumers.
          </p>
        </div>
        <div>
          <p>
            <span>General Data Protection Regulation (GDPR):</span> The General
            Data Protection Regulation is a European Union (EU) regulation
            charged with defining the extent of data protection and privacy for
            all individuals within the European Economic Area (EEA).
          </p>
        </div>
        <div>
          <p>
            ...
            a Canadian federal privacy law charged with regulating
            private-sector organizations to promote consumer trust in electronic
            commerce.
          </p>
        </div>
        <div>
          <p>
            <span>Australian Privacy Act (AU Privacy Act):</span> The Australian
            Privacy Act of 1988 is the principal piece of Australian legislation
            protecting the handling of the personal information of Australian
            individuals
          </p>
        </div>
        <div>
          <p>
            <span>Indian Information Technology Act (IT Act):</span> The
            Information Technology Act, 2000 is the principal piece of Indian
            legislation protecting the handling of personal information by
            corporate entities.
          </p>
        </div>
        <div>
          <p>
            ...
            The APPI is the central piece of Japanese legislation that mandates
            the protection of personal information for Japanese individuals,
            including extraterritorial businesses that, in relation to supplying
            a good or service to a person residing in Japan, have collected
            personal information.
          </p>
        </div>
        <div>
          <p>
            <span>United Kingdom Data Protection Act (UK DPA):</span> The United
            Kingdom Data Protection Act is a General Data Protection Regulation.
            UK DPA sets out the key principles, rights, and obligations for most
