...
export default function TermsAndConditions() {
  return (
    <section className={classes["terms-conditions"]}>
      <h1>Terms & Conditions</h1>
      <div className={classes["terms-conditions-body"]}>
        <div>
          <p>
            ...
            resulting from this transaction and agrees that the laws of the
        ...
        <div>
          <p>
            Final determination of suitability of any item sold for the use
            contemplated by purchaser is the sole responsibility of the
            purchaser, and Seller shall have no responsibility in connection
        ...
        <div>
          <p>
            ...
            knowledge. Should this apply to your order, we will, at our
        ...
        <div>
          <p>
            We make every effort to provide you with an error-free Web site.
            However, in the event there is a misprint, we reserve the right to
            correct copy or pricing to reflect the actual current status.
          </p>
        </div>
        <div>
          <p>
