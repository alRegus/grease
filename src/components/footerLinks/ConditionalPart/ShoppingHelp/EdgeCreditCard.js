  ...
  return (
    <section>
      <div
        style={{
          background:
            "url(https://i.ibb.co/MV6LgvF/Adorama-Quick-Apply-Header-1900.jpg)",
        }}
      >
        <h1>Adorama Edge Credit Card</h1>
        <p>
          Where payment flexibility and everyday rewards work to your advantage.
        </p>
        <div>
      ...
      <div>
        <div>
          ...
          <strong>
            ...
            12 Months Special Financing available on purchases of $800 or more.
          </strong>
          <p>
        ...
        <div>
          ...
          <p>
            Special Financing and 5% OFF Adorama Edge Credit Card benefit can’t
            be combined. You will be asked to select Special Financing (if
            purchase amount qualifies) or 5% OFF every day benefit at checkout.
          </p>
        </div>
      </div>
      <div>
        ...
        <p>
          ...
          We work with multiple lenders to find the best financing solution for
          you. See <a href="">financing details</a> for more information.⤉
        </p>
        <div>
          <div>
      ...
      <div>
        ...
        <p>
          Open an Adorama Edge Credit Card and take advantage of the perks that
      ...
      <div>
        ...
        <div>
          <h5>Where can I use my Adorama Edge Credit Card?</h5>
          <p>
        ...
        <div>
          <h5>How do I use the 5% OFF† Every Day benefits?</h5>
          <p>
        ...
        <div>
          <h5>How will I receive my Adorama Edge Credit Card Information?</h5>
          <p>
        ...
        <div>
          <h5>How can I manage my account?</h5>
          <p>
        ...
        <div>
          <h5>
            Can I use the Adorama Edge Credit Card for purchases on the Business
