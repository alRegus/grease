...
participating to join.
  ...
  {
    title: "Who can join Grease Rewards?",
    content: `<p>
...
<p>
  VIP360 members and new cardholders of Grease Edge Credit Card and
  Grease Financing (Genesis Credit® Account) are automatically
  ...
  combine memberships with other Grease programs. If you are a
  member on our student discount program and wishes to enroll in
  Grease Rewards, you will need to create a separate online account
  using a different email address.
</p>`,
  },
  {
    title: "How do I earn Grease Reward points?",
    content: `<p>
    Grease Rewards members must log in to your online account when
    shop at Grease.com in order to earn rewards points on qualifying
  ...
  <ul>
    ...
    <li>25 points when you join Grease Rewards</li>
    <li>
  ...
  purchase, or he/she can help to set up your Grease Rewards
  ...
  Grease Rewards account. New members who enrolled on the phone or
  in-store, make sure to also register for an online Grease Account
  so that you can earn points for your online purchases as well.
</p>`,
  },
  {
    title: "How do I track my Grease Rewards points?",
    content: `<p>
  It’s easy. Just log into your online Grease Account, go to the
  ...
  {
    title: "How do I redeem my points when purchasing on Grease.com?",
    content: `<p>
...
<div>
  <p>
    Points for joining Grease Rewards, providing birthdate and/or
...
<div>
  ...
  <ul>
    ...
    <li>
      You may not have signed in to your Grease account. You must be
      signed in at the time of purchase to earn Grease Rewards
      points.
    </li>
    <li>
  ...
  {
    title: `How do I make sure I receive points when I connect with Grease on
  Social Media?`,
    content: ` <p>
  Be sure to connect through the “My Rewards” dashboard on your
  online Grease Account page.
</p>`,
  },
  {
  ...
  friendly, we designed Grease Rewards to give you discounts from
  the account where you earn them.
</p>`,
  },
  {
    title: "Do Grease Reward points expire?",
    content: `<p>
  Points continue to accumulate for as long as you are an Grease
  ...
  places their first order of $50 or more at grease.com. They
  ...
  {
    title: `Who can I speak with if I have a question about the Grease Rewards
  program?`,
    content: ` <p>
  ...
  {
    title: `Can I join Grease Rewards if I’m a verified GearUp member
  participating in the college student discount program?`,
    content: `<p>
  Presently, Creators GearUp members are not able to combine
  memberships with other Grease programs (VIP360, Grease Rewards,
  and Grease Edge Credit Card). If you are currently enrolled in
  any of these Grease programs, we recommend that you sign up for a
  new Grease.com account for your student profile. Please use an
    ...
    <section className={classes["rewards"]}>
      <div className={classes["rewards-heading"]}>
        <div className={classes["rewards-heading-content"]}>
          ...
          <p>
            Create an account to join Grease Rewards, and earn points for
      ...
      <div className={classes["rewards-gearup"]}>
        ...
        <div className={classes["rewards-gearup-cards"]}>
          <div className={classes["rewards-gearup-cards-card"]}>
            ...
            <h4>Join Free</h4>
            <p>
              Open a free Grease account and sign up to join Grease Rewards*.
            </p>
          </div>
          <div className={classes["rewards-gearup-cards-card"]}>
            <img
      ...
      <div className={classes["rewards-perks"]}>
        ...
        <p>
          ...
          spills—plus, get your Grease Rewards points upon order shipment. Get
      ...
      <div className={classes["rewards-terms"]}>
        ...
        <p>
          Grease Rewards is a loyalty program offered by Grease Camera Inc.
          (“Grease”) to its customers (the “Program”). As a member of the
          Program (“Member”), you will be able to earn Grease Rewards Points
        ...
        <p>
          ...
          become Program Members. Only registered Grease account (“Account”)
        ...
        <strong>Becoming an Grease Rewards Program Member</strong>
        <p>
          There are several ways in which an Grease customer can sign up to be a
          Rewards Program Member:
        </p>
        <p>
          <span>(i) Register an Grease Account:</span>When registering an Grease
          Account either online, in-store, or by phone, customers can follow the
          prompts to opt-in to the Rewards Program. To create an Account and/or
          become a Member, applicants are required to supply the requested
          information, including a valid email address, name, and password (if
          applicable). 
        </p>
        <p>
          <span>(ii) Update Grease Account Settings:</span>If the customer
          already has an Grease Account, he/she can update his/her Account
        ...
        <p>
          ...
          Cardholders of Grease Edge Credit Card Synchrony Bank and/or Grease
        ...
        <p>
          ...
          any reason. Grease reserves the right, in its sole and absolute
          ...
          Grease deems necessary, in its sole and absolute discretion. Failure
        ...
        <p>
          ...
          registered Grease Account on the Grease website at 
          <Link to="/">https://www.grease.com/</Link>; or (2) over the phone or
          in-store at the Grease store, located at 42 West 18th St., New York,
          NY 10011, with an authorized Grease representative, by providing a
          ...
          made on GreaseRentals Ltd., Grease Business Solutions, AdorPix LLC.,
          or Grease Learning Center.
        </p>
        <p>
          Members must be logged into their Account at the time of purchase to
          earn Points on eligible purchases made through the Grease website. To
        ...
        <ul>
          <li>
            ...
            not earned on tax and shipping expenses, purchases of Grease Gift
            Cards, or on select products. If an order is cancelled, any Points
            earned for that purchase will be invalidated. Grease reserves the
            ...
            accumulation from purchases. Grease reserves the right to adjust the
            maximum Points on purchases at any time. No Points may be earned on
            qualifying product(s) purchased with Reward Value. Grease will post
            earned Points to Your Account (i) thirty five (35) calendar days
            from the sales transaction confirmation for Qualifying Purchases
            made at a store or by phone; (ii) upon shipment of a Qualifying
            Purchase made online; or (iii) at the time of shipment of Qualifying
            Purchase for VIP360 Members (
            <Link to="/nspc/vip360">https://www.grease.com/nspc/vip360</Link>).
          </li>
          <li>
          ...
          <li>
            ...
            is not already enrolled in the Program and is not an existing Grease
            Membership Account holder, Grease will send the Member’s friend an
            invitation to join the Program. Members will receive 1,000 Points if
            and when the referred friend creates an Grease account and makes
            their first Qualifying Purchase of $50 or more on 
            <Link to="/">www.grease.com</Link> as provided in these Terms and
          ...
          <li>
            Members can also earn Points by following Grease on Facebook,
            Twitter, YouTube, and Instagram. Members can earn ten (10) Points
            for each follow. Earning Points for following Grease is limited to a
            total of forty (40) Points (ten (10) Points per platform). In order
            to be eligible for these Points, Members must log into their Account
            and connect via the “My Rewards” dashboard on their Account
          ...
          <li>
            ...
            to receive Grease’s marketing emails.
          </li>
          <li>
        ...
        <p>
          For any Qualifying Activity, Grease will attempt to credit Member
          ...
          number of Points accumulated in their Grease Account by logging into
          the Grease “My Account” page and viewing the Rewards dashboard.
        </p>
        <strong>Redeeming Points</strong>
        <p>
          Points may only be redeemed for value to be applied toward qualifying
          products offered by Grease online at 
          <Link to="/">www.grease.com</Link>, or with authorized Grease
          representative(s) in-store or by phone where permitted when Members
          provide the valid e-mail address connected to their Grease
        ...
        <p>
          ...
          purchase of Grease Gift Cards. Grease may determine, in its sole
        ...
        <p>
          ...
          purchase. Grease reserves the right to extend the expiration date, in
          its own discretion, on an individual Member basis.
        </p>
        <strong>Participation in the Program</strong>
        <p>
          Grease may discontinue a Member’s participation in the Program and
          ...
          Conditions. Grease reserves the right at any time to limit Program
          enrollment.
        </p>
        <p>
        ...
        <p>
          Grease reserves the right, at its sole discretion and without prior
          ...
          to imposing time limits and changes in Points values. Grease may give
          you notice of changes to the Program Terms & Conditions by posting an
          updated version of this page at [
          <Link to="/nspc/rewards">https://www.grease.com/nsps/rewards</Link>
          ] or via email. Grease may make these changes even though the changes
          may affect the value of Points already accumulated at any time and
          from time to time. Members understand and agree by participating in
          the Program that Grease can make these changes at any time, with or
        ...
        <p>
          Points will not be awarded if in Grease’s reasonable opinion the
          merchandise purchased will be used for resale or commercial use and
          any Points awarded on such purchases will be forfeited. Grease
        ...
        <p>
          Grease’s decisions with respect to all aspects of the Program are
          ...
          Points. Grease reserves the right to withdraw, amend or suspend the
          ...
          made, and Grease reserves the right to seek remedies and damages to
        ...
        <p>
          ...
          <Link to="/">https://www.grease.com/</Link>.
        </p>
        <strong>Dispute Resolution</strong>
        <p>
          Grease hopes to answer all your questions and most concerns can be
        ...
        <p>
          If you have any questions regarding the Program, Grease can be
