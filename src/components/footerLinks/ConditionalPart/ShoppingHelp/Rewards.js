...
export default function Rewards() {
  return (
    <section>
      <div
        style={{
          background: "url(https://i.ibb.co/mNSzP9K/header-bg-desktop.jpg)",
        }}
      >
        <div>
      ...
      <div>
        ...
        <div>
          ...
          <div>
            <div>
              <img
                src="https://i.ibb.co/S7x5kkT/Rewards-icon-Join.png"
                alt=""
              />
            ...
            <div>
              <img
                src="https://i.ibb.co/zJVGzXc/Rewards-icon-Shop.png"
                alt=""
              />
              <p>Shop With Us</p>
            ...
            <div>
              <img
                src="https://i.ibb.co/7rcjkv6/Rewards-icon-First.png"
                alt=""
              />
            ...
            <div>
              <img
                src="https://i.ibb.co/MMkDqFw/Rewards-icon-Refer.png"
                alt=""
              />
              <p>Refer A Friend</p>
              <span>1,000</span>
            ...
            <div>
              <img
                src="https://i.ibb.co/6P9H2z6/Rewards-icon-Bonus.png"
                alt=""
              />
              <p>Bonus Days</p>
              <p>Double Or More Points On Qualifying Items & Activities</p>
            </div>
      ...
      <div>
        ...
        <form>
          {" "}
          СЮДА ВСТАВИТЬ ЧАСТЬ ФОРМЫ ПРИ ПОДПИСКЕ( ТОЕСТЬ СДЕЛАТЬЕЁ ОТДЕЛЬНЫМ
          КОМПОНЕНТОМ)
        </form>
      </div>
      <div
        style={{
          background:
            "url(https://i.ibb.co/gwvBHyw/VIP360-G-Page-Banner-Refresh-Desktop-2x.jpg)",
        }}
      >
      ...
      <div>
        <h2>FAQ</h2>
        <div>
          <h5>How do I sign up for Adorama Rewards?</h5>
          <div>
            <p>
        ...
        <div>
          <h5>Who can join Adorama Rewards?</h5>
          <div>
            <p>
        ...
        <div>
          <h5>How do I earn Adorama Reward points?</h5>
          <div>
            <p>
        ...
        <div>
          <h5>Can I get points when I buy in-store or by phone?</h5>
          <div>
            <p>
        ...
        <div>
          <h5>How do I track my Adorama Rewards points?</h5>
          <div>
            <p>
        ...
        <div>
          <h5>How many points do I need before I can redeem rewards?</h5>
          <div>
            <p>
        ...
        <div>
          <h5>How do I redeem my points when purchasing on Adorama.com?</h5>
          <div>
            <p>
        ...
        <div>
          <h5>How long does it take for my points to appear?</h5>
          <div>
            <div>
        ...
        <div>
          <h5>Do I have to buy something to redeem a reward?</h5>
          <div>
            <p>
        ...
        <div>
          <h5>What happens to my points if I return a product?</h5>
          <div>
            <p>
        ...
        <div>
          <h5>
            I just checked my receipt and my point balance. How come I didn’t
            get all the points I thought I would?
          </h5>
          <div>
            <p>One of three things may have happened:</p>
            <ul>
              <li>
        ...
        <div>
          <h5>
            How do I make sure I receive points when I connect with Adorama on
            Social Media?
          </h5>
          <div>
            <p>
        ...
        <div>
          <h5>
            Can I transfer points or combine points from multiple accounts?
          </h5>
          <div>
            <p>
        ...
        <div>
          <h5>Do Adorama Reward points expire?</h5>
          <div>
            <p>
        ...
        <div>
          <h5>I referred my friend; how come I don’t see any reward points?</h5>
          <div>
            <p>
        ...
        <div>
          <h5>
            Who can I speak with if I have a question about the Adorama Rewards
            program?
          </h5>
          <div>
            <p>
        ...
        <div>
          <h5>
            Can I join Adorama Rewards if I’m a verified GearUp member
        ...
        <div>
          <h5>How do I opt out of Adorama Rewards?</h5>
          <div>
            <p>
      ...
      <div>
        <span>ADORAMA REWARDS TERMS & CONDITIONS</span>
        <span>
        ...
        <ul>
          <li>
            Accumulate 400 Points: Earn <strong>$5 Reward</strong>
          </li>
          <li>
            Accumulate 1,000 Points: Earn <strong>$10 Reward</strong>
          </li>
          <li>
            Accumulate 2,000 Points: Earn <strong>$20 Reward</strong>
          </li>
          <li>
            Accumulate 3,000 Points: Earn <strong>$30 Reward</strong>
          </li>
          <li>
            Accumulate 3,500 Points: Earn <strong>$35 Reward</strong>
          </li>
          <li>
            Accumulate 4,000 Points: Earn <strong>$40 Reward</strong>
          </li>
          <li>
            Accumulate 4,500 Points: Earn <strong>$45 Reward</strong>
          </li>
          <li>
            Accumulate 5,000 Points: Earn <strong>$50 Reward</strong>
          </li>
          <li>
            Accumulate 10,000 Points: Earn <strong>$100 Reward</strong>
          </li>
          <li>
            Accumulate 20,000 Points: Earn <strong>$200 Reward</strong>
          </li>
        </ul>
        <span>
        ...
        <span>
          ...
          resolved quickly and to your satisfaction by contacting us
          at 800-223-2500. If, however, there is an issue that needs to be
          resolved it must be resolved through final, binding arbitration. This
        ...
        <span>
          ...
          (i.e., costs associated with participating in the Program), and Member
          ...
          Official Rules, or the rights and obligations of the Member and
          Sponsor in connection with the Program, shall be governed by, and
        ...
        <span>
          Members are advised that California Civil Code § 1542 provides that: A
          ...
          TIME OF EXECUTING THE RELEASE, AND THAT IF KNOWN BY HIM WOULD HAVE
          MATERIALLY AFFECTED HIS SETTLEMENT WITH THE DEBTOR OR RELEASED PARTY.
          By participating in the Program, Members, on behalf of himself/herself
          and his/her heirs, successors, assigns, agents and representatives,
          acknowledges that he/she understands the significance and consequences
          of California Civil Code § 1542 and, to the extent it may be
          applicable, hereby waives the benefits of its provisions, with the
          intent that the releases and waivers of liability in this section
